...
hostname = ip-10-224-43-80
uname -m = x86_64
uname -r = 3.2.0-24-virtual
uname -s = Linux
uname -v = #37-Ubuntu SMP Wed Apr 25 10:17:19 UTC 2012
...
PATH: /srv/node/happn/node_modules/iconv/node_modules/.bin
PATH: /srv/node/happn/node_modules/.bin
PATH: /usr/local/sbin
PATH: /usr/local/bin
PATH: /usr/sbin
PATH: /usr/bin
...
/tmp/ccmwq7Yx.o: In function `main':
/srv/node/happn/node_modules/iconv/deps/libiconv/conftest.c:63: undefined reference to `_NSGetExecutablePath'
...
configure:24533: === configuring in libcharset (/srv/node/happn/node_modules/iconv/deps/libiconv/libcharset)
...
configure:24533: === configuring in preload (/srv/node/happn/node_modules/iconv/deps/libiconv/preload)
configure:24596: running /bin/bash ./configure --disable-option-checking '--prefix=/usr/local'  '--disable-shared' '--enable-static' '--enable-relocatable' '--enable-extra-encodings' --cache-file=/dev/null --srcdir=.
...
ACLOCAL='${SHELL} /srv/node/happn/node_modules/iconv/deps/libiconv/build-aux/missing --run aclocal-1.11'
ALLOCA=''
ALLOCA_H='alloca.h'
AMDEPBACKSLASH='\'
AMDEP_FALSE='#'
AMDEP_TRUE=''
AMTAR='${SHELL} /srv/node/happn/node_modules/iconv/deps/libiconv/build-aux/missing --run tar'
APPLE_UNIVERSAL_BUILD='0'
AR='ar'
ARFLAGS='cru'
AS='as'
ASM_SYMBOL_PREFIX='""'
AUTOCONF='${SHELL} /srv/node/happn/node_modules/iconv/deps/libiconv/build-aux/missing --run autoconf'
AUTOHEADER='${SHELL} /srv/node/happn/node_modules/iconv/deps/libiconv/build-aux/missing --run autoheader'
AUTOMAKE='${SHELL} /srv/node/happn/node_modules/iconv/deps/libiconv/build-aux/missing --run automake-1.11'
AWK='mawk'
BITSIZEOF_PTRDIFF_T=''
...
LTLIBINTL=''
LTLIBOBJS=''
MAKEINFO='${SHELL} /srv/node/happn/node_modules/iconv/deps/libiconv/build-aux/missing --run makeinfo'
MANIFEST_TOOL=':'
MKDIR_P='/bin/mkdir -p'
MSGFMT=':'
MSGFMT_015=':'
...
install_sh='${SHELL} /srv/node/happn/node_modules/iconv/deps/libiconv/build-aux/install-sh'
